...
for i in stocks:
    ...
    find_query_1 = "<span id=\"yfs_l86_" #this is part of the tag that appears before the price i'm looking for
    find_query_2 = "\">(.+)</span></span> <span class=\"" #this follows the price i'm looking for
